...
import 'package:flutter_web/app_delegate.dart';
...
import 'package:flutter_web/pages.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // Add your fluro router instance generator here
    );
    ...
    GoRoute(
      ...
      routes: <RouteBase>[
        ...
        GoRoute(
          path: 'pageThree',
          builder: (context, state) {
            return  PageThree(param: state.extra.toString(),);
          },
        ),
        GoRoute(
          path: 'pageFour',
